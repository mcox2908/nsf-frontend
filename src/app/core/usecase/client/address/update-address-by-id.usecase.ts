...
export class UpdateAddressByIdUsecase implements UseCasePromise<AddressModel, AddressModel> {
    ...
    execute(address: AddressModel): Promise<ResponseData<AddressModel>> {
        ...
        return this._addressRepository.updateAddressById(address.id, address)
    }
}
